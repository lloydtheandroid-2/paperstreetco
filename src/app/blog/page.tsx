...
export default function BlogFaqPage() {
  return (
    <div className="max-w-4xl mx-auto">
      <h1 className="text-4xl font-bold mb-4">Blog & FAQ</h1>
      <p className="text-muted-foreground mb-8">Your questions and our thoughts, all in one place.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        <Card>
          ...
          <CardContent>
            <p>We've reconsidered the first rule. It's time to talk about it.</p>
          </CardContent>
        </Card>
         <Card>
          <CardHeader>
          ...
          <CardContent>
            <p>The things you own end up owning you. A treatise on modern ownership.</p>
          </CardContent>
        </Card>
         <Card>
          <CardHeader>
